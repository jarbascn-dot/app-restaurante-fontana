...
export default function App() {
  ...
  const handleUpdateNotifications = (enabled: boolean, timing: 'vespera' | 'mesmo_dia', time: string) => {
    const updatedUser = { 
      ...currentUser, 
    ...
    setCurrentUser(updatedUser);
    saveToFirestore('usuarios', updatedUser);
    appendAuditLog(`Alterou configurações de alertas para: ${enabled ? 'Habilitado' : 'Desabilitado'} (${timing === 'vespera' ? 'Véspera' : 'No dia'} às ${time})`);
  };
