  ...
  React.useEffect(() => {
    if (todayDate) {
      ...
      if (parts.length === 3) {
        ...
        // If todayDate is the static simulation date '2026-06-13', let's NOT force the calendar view to June.
        // Instead, keep the real-world current month/year for the calendar view so it's always in the current month as requested.
        if (todayDate !== '2026-06-13') {
          setCurrentYear(yr);
          setCurrentMonth(mn);
        }
