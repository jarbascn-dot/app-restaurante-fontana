...
export default function GestorView({
  ...
  // Count reservations for today under this specific site (June 13, 2026)
  const reportDate = '2026-06-13';
  ...
  const reservasSiteMes = reservas.filter(r => {
    const isJune = r.data.startsWith('2026-06');
  ...
  return (
    <div className="space-y-6" id="gestor-view-panel">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl border border-neutral-200 shadow-sm">
          <span className="block text-[10px] font-mono text-neutral-500 uppercase">Marmitas Hoje ({reportDate})</span>
