                ...
                <div className="space-y-4 border-l-2 border-emerald-500 pl-4 py-1 animate-[fadeIn_0.25s_ease] space-y-3">
                  ...
                  <div className="bg-amber-50 text-amber-950 text-[10px] leading-relaxed p-3 rounded-lg border border-amber-250">
                    <p className="font-bold flex items-center gap-1 mb-1">
                      ⚠️ ATENÇÃO PARA O SEU CELULAR:
                    </p>
                    {isInstalledPwa ? (
                      <p className="font-semibold text-emerald-800 bg-emerald-50 p-2 rounded border border-emerald-200 mb-1.5">
                        📱 Você já está usando o SGR Fontana como Aplicativo Instalado (PWA)! Conceda a permissão de notificações no prompt do celular quando solicitado para receber os alertas diários de refeição.
                      </p>
                    ) : (
                      <p className="font-semibold text-amber-900 bg-amber-100/50 p-2 rounded border border-amber-200 mb-1.5">
                        📥 Para receber notificações no celular, instale o app na tela inicial e conceda permissão de notificações quando solicitado.
                      </p>
                    )}
                    <p>
                    ...
                    <ul className="list-disc pl-4 space-y-1 mt-0.5 font-medium/80">
                      ...
                      <li>Os lembretes não requerem internet após ativados e serão mostrados imediatamente pelo Service Worker integrado.</li>
                    </ul>
                  </div>
